<!DOCTYPE html>
  ...
  <nav class="transparent z-depth-0" style="background: red;">
    <div class="nav-wrapper">
      <div class="row">
        <div class="col s12" style="padding: 20px;">
          <a href="https://codepen.io/collection/nbBqgY/" class="brand-logo" target="_blank"><img src="img/logo2.1.png" alt="" width="300" height="60"></a>
          <ul class="right hide-on-med-and-down">
            <li><a class="waves-effect waves-light btn-small">Inicio</a></li>
            <li><a class="waves-effect waves-light btn-small">Conócenos</a></li>
            <li><a class="waves-effect waves-light btn-small">Productos</a></li>
            <li><a class="waves-effect waves-light btn-small">Contáctanos</a></li>
            <li><a class="waves-effect waves-light btn-small">Blog</a></li>
